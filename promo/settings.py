...
BASE_DISCOUNT_URL_DIXY_SKIDKI_NEDELI = '{}{}'.format(BASE_URL, '/akcii/skidki-nedeli/?PAGEN_1=')
PATH_WHOLE_CONTENT_DIXY_SKIDKI_NEDELI = '//div[contains(@class, "elem-badge-cornered")]/text()'
...
PATH_PRICE_NEW_DIXY_SKIDKI_NEDELI = '//span[@class="price-discount__integer"]/text()'
PATH_PRICE_OLD_DIXY_SKIDKI_NEDELI = '//div[@class="elem-product__price-container"]/div[@class="just-now"]/text()|//span[@class="price-full__integer"]/text()'
PATH_TITLE_DIXY_SKIDKI_NEDELI = '//div[contains(@class, "elem-badge-cornered")]/text()'
